...
export const SungmanitoTheme = {
  ...
  properties: {
    ...
    // success | #10ff28
    '--color-success-50': '219 255 223', // #dbffdf
    '--color-success-100': '207 255 212', // #cfffd4
    '--color-success-200': '195 255 201', // #c3ffc9
    '--color-success-300': '159 255 169', // #9fffa9
    '--color-success-400': '88 255 105', // #58ff69
    '--color-success-500': '16 255 40', // #10ff28
    '--color-success-600': '14 230 36', // #0ee624
    '--color-success-700': '12 191 30', // #0cbf1e
    '--color-success-800': '10 153 24', // #0a9918
    '--color-success-900': '8 125 20', // #087d14
    // warning | #EAB308
