...
export const payments = pgTable(
  ...
  (table) => [
    uniqueIndex('billId_month').using(
      'btree',
      table.billId.asc().nullsLast().op('date_ops'),
      table.forMonthD.asc().nullsLast().op('date_ops'),
    ),
    index('month_idx').using(
      'btree',
      table.forMonthD.asc().nullsLast().op('date_ops'),
    ),
    index('payment_household_idx').using(
      'btree',
      table.householdId.asc().nullsLast().op('text_ops'),
    ),
    uniqueIndex('proof_image_idx').using(
      'btree',
      table.proofImageId.asc().nullsLast().op('uuid_ops'),
    ),
    foreignKey({
...
export const invites = pgTable(
  ...
  (table) => [
    index('from_id_idx').using(
      'btree',
      table.fromId.asc().nullsLast().op('uuid_ops'),
    ),
    index('invites_household_idx').using(
      'btree',
      table.householdId.asc().nullsLast().op('text_ops'),
    ),
    index('to_id_idx').using(
      'btree',
      table.toId.asc().nullsLast().op('uuid_ops'),
    ),
    foreignKey({
...
export const households = pgTable(
  ...
  (table) => [
    index('name_index').using(
      'btree',
      table.name.asc().nullsLast().op('text_ops'),
    ),
    index('owner_id').using(
      'btree',
      table.ownerId.asc().nullsLast().op('uuid_ops'),
    ),
    index('updated_at_idx').using(
      'btree',
...
export const usersToHouseholds = pgTable(
  ...
  (table) => [
    index('household_household_id_index').using(
      'btree',
      table.householdId.asc().nullsLast().op('text_ops'),
    ),
    index('household_user_id_index').using(
      'btree',
      table.userId.asc().nullsLast().op('uuid_ops'),
    ),
    uniqueIndex('user_id_household_id_index').using(
      'btree',
